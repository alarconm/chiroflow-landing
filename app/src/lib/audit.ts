...
export type AuditAction =
  ...
  | 'AI_NL_QUERY'
  | 'AI_FULL_ANALYSIS'
  // AI Predictive Analytics actions (Epic 40)
  ...
  // AI Trend Detection actions (Epic 40 - US-385)
  ...
  | 'AI_GROWTH_LEAD_CAPTURED'
  | 'AI_GROWTH_LEAD_SCORED'
  | 'AI_GROWTH_LEAD_ASSIGNED'
  | 'AI_GROWTH_LEAD_STATUS_UPDATED'
  | 'AI_GROWTH_LEAD_CONVERTED'
  | 'AI_GROWTH_NURTURE_STARTED'
  | 'AI_GROWTH_BULK_SCORE'
  // AI Practice Growth - Lead Nurturing (US-357)
  | 'AI_GROWTH_NURTURE_ADVANCED'
  | 'AI_GROWTH_NURTURE_ENGAGEMENT'
  | 'AI_GROWTH_RESPONSE_HANDLED'
  | 'AI_GROWTH_NURTURE_PAUSED'
  | 'AI_GROWTH_NURTURE_RESUMED'
  | 'AI_GROWTH_LEAD_ESCALATED'
  // AI Practice Growth - Reputation Management (US-358)
  | 'AI_GROWTH_REVIEW_REQUESTED'
  | 'AI_GROWTH_BULK_REVIEW_REQUEST'
  | 'AI_GROWTH_METRICS_UPDATED'
  | 'AI_GROWTH_NEGATIVE_REVIEW_ALERT'
  | 'AI_GROWTH_REVIEW_ALERT_ACTION'
  // AI Practice Growth - Referral Optimization (US-359)
  | 'AI_GROWTH_NPS_CALCULATED'
  | 'AI_GROWTH_REFERRAL_PROGRAM_PROMOTED'
  | 'AI_GROWTH_REFERRAL_TRACKED'
  | 'AI_GROWTH_REFERRAL_THANKYOU_SENT'
  | 'AI_GROWTH_REFERRAL_REWARD_ISSUED'
  | 'AI_GROWTH_PROVIDER_NURTURED'
  | 'AI_GROWTH_PROVIDER_CREATED'
  // AI Practice Growth - Patient Reactivation (US-360)
  | 'AI_GROWTH_REACTIVATION_IDENTIFIED'
  | 'AI_GROWTH_REACTIVATION_OUTREACH'
  | 'AI_GROWTH_REACTIVATION_RESPONSE'
  | 'AI_GROWTH_REACTIVATION_SUCCESS'
  | 'AI_GROWTH_REACTIVATION_OFFER_SENT'
  | 'AI_GROWTH_REACTIVATION_ANALYSIS'
  | 'AI_GROWTH_REACTIVATION_BULK_OUTREACH'
  // AI Practice Growth - Marketing Campaign Automation (US-361)
  | 'AI_GROWTH_CAMPAIGN_CREATED'
  | 'AI_GROWTH_CAMPAIGN_UPDATED'
  | 'AI_GROWTH_CAMPAIGN_ACTIVATED'
  | 'AI_GROWTH_CAMPAIGN_PAUSED'
  | 'AI_GROWTH_CAMPAIGN_COMPLETED'
  | 'AI_GROWTH_CAMPAIGN_CANCELLED'
  | 'AI_GROWTH_AUDIENCE_SEGMENTED'
  | 'AI_GROWTH_CONTENT_GENERATED'
  | 'AI_GROWTH_ABTEST_CREATED'
  | 'AI_GROWTH_ABTEST_RESULT'
  | 'AI_GROWTH_CAMPAIGN_OPTIMIZED'
  | 'AI_GROWTH_ROI_CALCULATED'
  // AI Staff Training (Epic 38)
  | 'TRAINING_START'
  | 'TRAINING_COMPLETE'
  | 'TRAINING_FAIL'
  ...
  // AI Clinical Decision Support (Epic 39)
