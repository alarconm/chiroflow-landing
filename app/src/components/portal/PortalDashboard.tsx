...
/**
 * Epic 14: Patient Portal - Dashboard Component
 * Re-exports the dashboard page content for backwards compatibility
 * The main dashboard logic is now in app/src/app/portal/dashboard/page.tsx
 */
...
const HEALTH_TIPS = [
  {
    title: 'Stay Hydrated',
    description: 'Drink at least 8 glasses of water daily to keep your spine healthy.',
    icon: Activity,
  },
  {
    title: 'Practice Good Posture',
    description: 'Keep your shoulders back and avoid slouching to reduce strain.',
    icon: User,
  },
  {
    title: 'Stretch Daily',
    description: 'Take 5-10 minutes each morning to stretch your back and neck.',
    icon: Heart,
  },
];
        ...
        {quickLinks.map((link) => {
          ...
          return (
            <Link key={link.href} href={link.href}>
              <Card className="hover:shadow-md transition-all cursor-pointer h-full border-stone-200 hover:border-blue-300">
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-[#053e67]">
                            Please complete before your next visit
                          </p>
                        </div>
                      </div>
